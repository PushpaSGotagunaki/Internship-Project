...
<head>
    ...
    <body>
        <h1>Dear User</h1>
        <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Product Price:<strong>${pprice}</strong></h2>
...
?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    <button
                                                        onclick="printDiv(<?php echo $price=$row['pprice'];?>)">Download</button>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $cnt=$cnt+1;} ?>
    ...
    $(window).bind("load", function() {
        $('.show-theme-options').delay(2000).trigger(
            'click');
    });
    </script>
